...
void leerArr(int matrizA[][100], int matrizB[][100], int filaA, int filaB, int colA, int colB)
{
  ...
  for (int i = 0; i < filaA; i++)
  {
    ...
    {
      cout << "Ingresa el valor de la primera matriz de la posicion " << i << " " << j << endl;
      cin >> matrizA[i][j];
    }
  }
  for (int i = 0; i < filaB; i++)
  {
    ...
    {
      cout << "Ingresa el valor de la segunda matriz de la posicion " << i << " " << j << endl;
      cin >> matrizB[i][j];
    }
  }
}
...
void sumaMatrices(int matrizA[][100], int matrizB[][100], int matrizC[][100], int nC, int nF)
{
